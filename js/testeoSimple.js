        ...
        fetch(`${url}trxCampanias/Testear`, requestOptions)
            ...
            .then(async data => {
                ...
                data.forEach((element, index) => {
                    ...
                    const { datosCampania, validacionPresupuesto, validacionEtapa, otrasValidaciones, premios } = element;
                    ...
                    //porcentaje de etapa
                    const porEtapas = ((parseInt(validacionEtapa.etapaActual)) * 100) / parseInt(validacionEtapa.totalEtapas);
                    const porNewEtapas = ((parseInt(validacionEtapa.etapaActual) + 1) * 100) / parseInt(validacionEtapa.totalEtapas);
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <h5><small>Limite Participantes ${validacionPresupuesto.limiteGanadores} /  ${validacionPresupuesto.cantParticipaciones} + 1</small></h5>
                        ...
                        <div class="col-md-2">
                            <h5><small>Etapas ${validacionEtapa.totalEtapas} /  ${validacionEtapa.etapaActual}  + 1</small></h5>
                            <div class="progress p-0" style="width: 100%; height: 15%">
